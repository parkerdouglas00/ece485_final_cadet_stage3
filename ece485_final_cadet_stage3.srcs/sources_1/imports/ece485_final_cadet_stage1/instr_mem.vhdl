...
architecture Behavioral of instr_mem is
    ...
    signal memory : memory_array := (
        ...
        17  => x"00000000",
        18  => x"00000000",
        19  => x"F20290E3", --     bne x5, x0, loop   1 [jump -20; note: assumes PC is incremented by 4]    --  1 111111 00000 00101 001 011 0 1 1100011        xx => x"FF9FF06F", -- done: j done            [-4; note: assumes PC is already incremented by 4]
        20  => x"00000000",
        21  => x"00000000",
        22  => x"00000000",
        23  => x"FF9FF06F", -- done: j done             [jump -4; note: assumes PC is incremented by 4]   --  1 1111111110 1 11111111 00000 1101111
        others => (others => '0')
...
--        7 => x"FA0298E3", --     bne x5, x0, loop   1 [jump -20; note: assumes PC is incremented by 4]    --  1 111111 00000 00101 001 011 0 1 1100011
